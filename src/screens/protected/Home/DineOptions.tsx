          ...
          <TouchableOpacity
            ...
            onPress={() =>
              navigation.navigate("Main", {
                ...
                params: {
                  screen: "SeatedPath", // then navigate inside Home stack to RestaurantMenu
                },
              })
            }
          >
          ...
          <TouchableOpacity
            ...
            onPress={() =>
              navigation.navigate("Main", {
                screen: "Home", // first, go into Home stack inside Main
                params: {
                  screen: "InTransitPath", // then navigate inside Home stack to RestaurantMenu
                },
              })
            }
          >
          ...
          <TouchableOpacity
            ...
            onPress={() =>
              navigation.navigate("Main", {
                screen: "Home", // first, go into Home stack inside Main
                params: {
                  screen: "TakeoutPath", // then navigate inside Home stack to RestaurantMenu
                },
              })
            }
          >
